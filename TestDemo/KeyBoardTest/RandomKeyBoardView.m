...
//键盘背景色
#define RANDOMKEYBOARD_BACKGROUNDCOLOR  [UIColor colorWithRed:(float)44/255.0f green:(float)92/255.0f blue:(float)160/255.0f alpha:1.0]
//固定按钮颜色
...
#define kChar_Letter_Arr        @[@"a",@"b",@"c",@"d",@"e",@"f",@"g",@"h",@"i",@"j",@"k",@"l",@"m",@"n",@"o",@"p",@"q",@"r",@"s",@"t",@"u",@"v",@"w",@"x",@"y",@"z"]
